        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-4 col-sm-4">
                        <label for="graduate_no" class="control-label m">Graduate No *</label>
                    </div>
                    <div class="col-lg-8 col-sm-8">
                        <input id="graduate_no" name="graduate_no" placeholder="graduate_no" type="text"
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="last_name" name="last_name" placeholder="last_name" type="text" class="form-control"
            ...
            <div class="form-group">
                <div class="row colbox">
                    <div class="col-lg-4 col-sm-4">
                        <label for="worker_level_id" class="control-label m">Worker Type *</label>
                    </div>
                    <div class="col-lg-8 col-sm-8">
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="adjusted_salary" name="adjusted_salary" placeholder="adjusted_salary" type="text" class="form-control"
            ...
            <div class="form-group">
                <div class="row colbox">
                    <div class="col-lg-4 col-sm-4">
                        <label for="do_not_assign_outside_preferences" class="control-label">Do NOT Assign Outside of Preferences?</label>
                    </div>
                    <div class="col-lg-8 col-sm-8">
